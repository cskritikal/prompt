...
11. Orchestration: Title/Type/Suppresses/Why-safe/KVP only; KVP rows PRESENT; 2–4 rows, strongest anchor first, no volatile identifier; LOLBin anchored to behavior not parent+host; Manual Closing (not a filter) when anchors <2 / filter unsafe.
